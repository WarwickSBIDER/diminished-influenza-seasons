#=
Purpose:
Take outputs from influenza season 2021/2022 scenarios and get
...
function get_severity_counts(infected_propn_by_age,risk_status_val)
    ...
    # Get 2021/2022 data
    cases_by_strain_2021_2022 = infected_propn_by_age[end,:,:]
    ...
    for age_itr = 1:n_ages
        for strain_itr = 1:n_strains
            ascertained_cases_by_age[age_itr,strain_itr] = ascertained_by_age[age_itr].*cases_by_strain_2021_2022[age_itr,strain_itr]
        end
    end

    # Aggregate ascertained cases based on strain type
    ascertained_cases_type_A_2021_2022 = sum(ascertained_cases_by_age[:,1:2],dims=2)
    ascertained_cases_type_B_2021_2022 = sum(ascertained_cases_by_age[:,3:4],dims=2)
    ascertained_cases_2021_2022 = vec(sum(ascertained_cases_by_age,dims=2))
...
0,
    ...
    for age_itr = 1:n_ages
        ...
        if risk_status_val == "low_risk"
            inpatient_propn_of_age[age_itr] =
                    (inpatient_low_risk_type_A[bin_idx].*ascertained_cases_type_A_2021_2022[age_itr]) +
                    (inpatient_low_risk_type_B[bin_idx].*ascertained_cases_type_B_2021_2022[age_itr])
        elseif risk_status_val == "at_risk"
            inpatient_propn_of_age[age_itr] =
                    (inpatient_at_risk_type_A[bin_idx].*ascertained_cases_type_A_2021_2022[age_itr]) +
                    (inpatient_at_risk_type_B[bin_idx].*ascertained_cases_type_B_2021_2022[age_itr])
        end
    end
    ...
    for age_itr = 1:n_ages
        ...
        if risk_status_val == "low_risk"
            in_hospital_death_propn_of_age[age_itr] =
                    inhospital_death_low_risk_type_A[bin_idx].*ascertained_cases_type_A_2021_2022[age_itr]
        elseif risk_status_val == "at_risk"
            in_hospital_death_propn_of_age[age_itr] =
                inhospital_death_at_risk_type_A[bin_idx].*ascertained_cases_type_A_2021_2022[age_itr]
        end
    end
    ...
    return ascertained_cases_2021_2022::Array{Float64,1},
...
infected_propn_by_age_scen1_lowrisk = SimnDataAllPopn_scen1_lowrisk[:,1]
...
infected_propn_by_age_scen1_atrisk = SimnDataAllPopn_scen1_atrisk[:,1]
popn_dist_scen1_atrisk = SimnDataAllPopn_scen1_atrisk[:,2]
...
# COVID impacted, no influenza in 2020/2021 flu season scenario
at_risk_scen1_cases_propn_of_age,
        at_risk_scen1_inpatient_propn_of_age,
        at_risk_scen1_in_hospital_death_propn_of_age,
        at_risk_scen1_out_of_hospital_death_propn_of_age,
        low_risk_scen1_cases_propn_of_age,
        low_risk_scen1_inpatient_propn_of_age,
        low_risk_scen1_in_hospital_death_propn_of_age,
        low_risk_scen1_out_of_hospital_death_propn_of_age,
        overall_scen1_cases_propn_of_age,
        overall_scen1_inpatient_propn_of_age,
        overall_scen1_in_hospital_death_propn_of_age,
        overall_scen1_out_of_hospital_death_propn_of_age = get_event_propn_of_age_data(n_ages,n_replicates,
                                                                                    infected_propn_by_age_scen1_atrisk,
                                                                                    infected_propn_by_age_scen1_lowrisk)
...
# Put data to be compared into vector of arrays
    # low risk
low_risk_cases_propn_of_age = [low_risk_baseline_cases_propn_of_age,low_risk_scen1_cases_propn_of_age]
low_risk_inpatient_propn_of_age = [low_risk_baseline_inpatient_propn_of_age,low_risk_scen1_inpatient_propn_of_age]
low_risk_in_hospital_death_propn_of_age = [low_risk_baseline_in_hospital_death_propn_of_age,low_risk_scen1_in_hospital_death_propn_of_age]
low_risk_out_of_hospital_death_propn_of_age = [low_risk_baseline_out_of_hospital_death_propn_of_age,low_risk_scen1_out_of_hospital_death_propn_of_age]
...
low_risk_data_tuple = [low_risk_cases_propn_of_age,low_risk_inpatient_propn_of_age,
    ...
    # at-risk
at_risk_cases_propn_of_age = [at_risk_baseline_cases_propn_of_age,at_risk_scen1_cases_propn_of_age]
at_risk_inpatient_propn_of_age = [at_risk_baseline_inpatient_propn_of_age,at_risk_scen1_inpatient_propn_of_age]
at_risk_in_hospital_death_propn_of_age = [at_risk_baseline_in_hospital_death_propn_of_age,at_risk_scen1_in_hospital_death_propn_of_age]
at_risk_out_of_hospital_death_propn_of_age= [at_risk_baseline_out_of_hospital_death_propn_of_age,at_risk_scen1_out_of_hospital_death_propn_of_age]
...
at_risk_data_tuple = [at_risk_cases_propn_of_age,at_risk_inpatient_propn_of_age,
    ...
    # overall
overall_cases_propn_of_age = [overall_baseline_cases_propn_of_age,overall_scen1_cases_propn_of_age]
overall_inpatient_propn_of_age = [overall_baseline_inpatient_propn_of_age,overall_scen1_inpatient_propn_of_age]
overall_in_hospital_death_propn_of_age = [overall_baseline_in_hospital_death_propn_of_age,overall_scen1_in_hospital_death_propn_of_age]
overall_out_of_hospital_death_propn_of_age= [overall_baseline_out_of_hospital_death_propn_of_age,overall_scen1_out_of_hospital_death_propn_of_age]
...
low_risk_popn_by_yr_of_age = readdlm("../../data/DemographicData/ONSPopnDistEngland20102020_0to100_LowRisk.txt",',')[end,:]
at_risk_popn_by_yr_of_age = readdlm("../../data/DemographicData/ONSPopnDistEngland20102020_0to100_AtRisk.txt",',')[end,:]
overall_popn_by_yr_of_age = readdlm("../../data/DemographicData/ONSPopnDistEngland20102020_0to100.txt",',')[end,:]
...
file = matopen("influenza_season_2021_2022_scenarios_rel_vals_copy.mat", "w")
