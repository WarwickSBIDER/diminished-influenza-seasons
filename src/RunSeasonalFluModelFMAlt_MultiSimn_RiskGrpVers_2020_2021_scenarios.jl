...
# Based on historical data up to 2019/2020
# For 2020/2021, aim for envisaged coverage levels in presence of COVID
function COVIDscen_VaccUptake_RecovRisk(SeasonsToSimulate,SimnRunType)
...
ONSPopnDistEngland20102019 = readdlm("../data/DemographicData/ONSPopnDistEngland20102019_0to100.txt",',')

# For 2020/2021 season, set population to be the same as for 2019.
ONSPopnDistEngland20102020 = [ONSPopnDistEngland20102019;ONSPopnDistEngland20102019[end,:]';ONSPopnDistEngland20102019[end,:]']
...
#--------------------------------------------------------------------------
FixedModelParams = [ContactArray,MortalityFile,ONSPopnDistEngland20102020,
...
VaccUptakeFunction = COVIDscen_VaccUptake_RecovRisk
